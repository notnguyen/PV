        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                switch (input)
                {
                    ...
                    case "2":
                        /*bool loginSuccessful = logIn.LoginFromFile(userName, password);
                        ...
                        {
                            Console.WriteLine("Přihlášení selhalo. Zkuste to prosím znovu.");
                        }*/

                        bool loginSuccessful = logIn.LogInCustomer();
