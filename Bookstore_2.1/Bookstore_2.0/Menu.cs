    ...
    public class Menu
    {
        ...
        public Menu()
        {
            ...
            menu["CustomerUpdate"] = new List<string> {
                "1) Aktualizovat Order",
                "2) Aktualizovat OrderBook",
                "3) Aktualizovat Address",
                "4) NÁVRAT DO HLAVNÍHO MENU"
            };
            ...
            menu["CustomerListAll"] = new List<string> {
                "1) Vypsat všechny Order",
                "2) Vypsat všechny OrderBook",
                "3) Vypsat všechny Address",
                "4) Vypsat všechny tabulky",
                "5) NÁVRAT DO HLAVNÍHO MENU"
            };

            menu["CustomerDeleteAll"] = new List<string> {
                "1) Smazat všechny Order",
                "2) Smazat všechny OrderBook",
                "3) Smazat všechny Address",
                "4) NÁVRAT DO HLAVNÍHO MENU"
            };
        }
